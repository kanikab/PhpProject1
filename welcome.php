...
<script src="http://bdhacker.sourceforge.net/javascript/countries/countries-2.0-min.js"></script>
 ...
 <!-- Navigation -->
    <center>
            <input type="button" name="Home" value="Home" onclick="window.location.href='globe.html'">
            <input type="button" name="Profile" value="Profile" onclick="window.location.href=''">
            <input type="button" name="Album" value="Albums" onclick="window.location.href='albums.php'">
            <input type="button" name="Upload" value="Upload" onclick="window.location.href='fileupload.php'">
    </center>
        <!-- Navigation -->
